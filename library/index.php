      ...
      <ul>
         ...
         <li class='has-sub'><a href='#'><span>Research Service</span></a>
            <ul>
               ...
               <li><a href='#'><span>KKU E-resource</span></a></li>
               <li><a href='#'><span>RSS</span></a></li>
               <li class='last'><a href='#'><span>ILL</span></a></li>
            </ul>
         </li>
  ...
  <div class="row">
    <div class="col-sm-6 col-md-6 col-lg-6">
      ...
      <map name="image-map">
        ...
        <area target="" alt="Working" title="Working" coords="381,334,116" shape="circle" href="#myModal">  
          <div id="myModal" name="myModal2" class="modal">
            <span class="close">&times;</span>
        ...
        <area target="" alt="Publishing" title="Publishing" coords="128,340,112" shape="circle"> 
          <div id="myModal" class="modal">
            ...
            <h3 style="color: white">Publication</h2>
            <div align="center">
            ...
            <h3 style="color: white">Research Ethics</h2>
            <div align="center">
